      ...
      <el-row>
        <el-col :span="24">
          <div class="float-right">
            ...
            <el-button type="info" plain size="small">清除</el-button>
          </div>
        ...
        <el-row>
          <el-col :span="6">
            <el-form-item label="建党时间" prop="maker">
              <el-date-picker v-model="formLabelAlign.registerTime" type="datetime" placeholder="选择日期时间" style="width:180px;"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="6">
...
export default {
  ...
  data() {
    return {
      currentContentNName: '人力资源档案登记', // 通过路由传参数实现
      isPromote: false,
